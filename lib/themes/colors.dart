// part of 'app_colors_shema.dart';
//
// class MainColor extends ColorSwatch<ColorType> {
//   const MainColor(int primary, {Map<ColorType, Color>? swatch})
//     : super(primary, swatch ?? const {});
//
...
//
// class StatusColors {
//   Color success, fail, pending, done;
//
//   StatusColors({
//     required this.fail,
...
//     required this.textLightH2,
//     required this.textDarkH1Body,
...
//
// class ShapeColors {
//   MainColor backgroundColor, cardColor, appBar, navBar, iconColor;
//   Color borderColor, dividerColor, disabledBackgroundColor, starColor;
//
//   ShapeColors({
...
//
//   Shadows({required this.mainShadow});
// }
//
// enum ColorType {
//   shade5,
...
//
// class AppPadding {
//   EdgeInsets mainPagePadding;
//
//   AppPadding({required this.mainPagePadding});
// }
