...
class BasePaginatedListState<T> {
  ...
  BasePaginatedListState<T> setInProgressState() =>
      BasePaginatedListState<T>(status: PaginatedListStatus.inProgress);

  BasePaginatedListState<T> setSuccessState(List<T> items, int totalRecords) =>
      BasePaginatedListState<T>(
        status: PaginatedListStatus.success,
        items: items,
        hasReachedMax: items.length >= totalRecords,
